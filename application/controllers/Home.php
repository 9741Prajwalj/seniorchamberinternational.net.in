...
class Home extends CI_Controller {
    ...
    public function index()
    {
        ...
        $page_data['channel_partner_list'] = $this->db->get_where('channel_partner')->result();
        $page_data['blogs_list'] = $this->db->get_where('blogs')->result();
    ...
    /*  echo"<pre>";
        ...
        */
        ...
        $this->load->view('front/profile/userkundali_modal', $page_data);
    }
...
if ($para1 == "add") {
 ...
 function astro_tips()
    ...
    public function marriage_application_details(){
        ...
        $data['bride_dob'] = $_POST['bride_dob'];
        $data['bride_place_of_birth'] = $_POST['bride_place_of_birth'];
        $data['bride_time_of_birth'] = $_POST['bride_time_of_birth'];
        $data['bride_raashi'] = $_POST['bride_raashi'];
        $data['bride_nakshathra'] = $_POST['bride_nakshathra'];
        $data['bride_mobile'] = $_POST['bride_mobile'];
        $data['bride_address'] = $_POST['bride_address'];
        $data['bride_mother_name'] = $_POST['bride_mother_name'];
        $data['bride_father_name'] = $_POST['bride_father_name'];
        ...
        $data['groom_place_of_birth'] = $_POST['groom_place_of_birth'];
        $data['groom_time_of_birth'] = $_POST['groom_time_of_birth'];
        $data['groom_raashi'] = $_POST['groom_raashi'];
        $data['groom_nakshathra'] = $_POST['groom_nakshathra'];
        $data['groom_email'] = $_POST['groom_email'];
        $data['groom_address'] = $_POST['groom_address'];
        $data['groom_mobile'] = $_POST['groom_mobile'];
        $data['groom_mother_name'] = $_POST['groom_mother_name'];
        $data['groom_father_name'] = $_POST['groom_father_name'];
        $data['groom_parent_address'] = $_POST['groom_parent_address'];
