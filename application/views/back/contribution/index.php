...
<a href="<?=base_url()?>admin/contribution/edit_package/<?=$value->plan_id?>" id="demo-dt-view-btn" class="btn btn-mint add-tooltip" style="width: 100%" ><i class="fa fa-edit"></i> <?php echo translate('edit')?></a>
						            </div>
					            </div>
					        </div>
					        <!--===================================================-->
						...
						<div class="col-sm-4 col-lg-3">
					        ...
					        <div class="panel panel-bordered-primary">
					            <div class="panel-body">
					            	...
					            	<div class="col-sm-12 edit-btn">
<a href="<?=base_url()?>admin/contribution/edit_package/<?=$value->plan_id?>" id="demo-dt-view-btn" class="btn btn-primary add-tooltip" style="width: 100%" ><i class="fa fa-edit"></i> <?php echo translate('edit')?></a>
						            </div>
					            </div>
					        </div>
					        <!--===================================================-->
...
<script>
	...
	$("#delete_package").click(function(){
    	$.ajax({
		    url: "<?=base_url()?>admin/contribution/delete/"+$("#delete_package").val(),
		    success: function(response) {
				window.location.href = "<?=base_url()?>admin/contribution";
		    },
			fail: function (error) {
			    alert(error);
			}
